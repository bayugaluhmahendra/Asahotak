...
const SUPABASE_URL = 'https://kcpmxxvqeyehdskyzinr.supabase.co/rest/v1/leaderboard';
...
try {
    if (SUPABASE_URL !== 'https://kcpmxxvqeyehdskyzinr.supabase.co/rest/v1/leaderboard') {
        supabaseClient = supabase.createClient('const _supabase = supabase.createClient(SUPABASE_URL, SUPABASE_ANON_KEY);
 ');
 );
    }
} catch (e) {
